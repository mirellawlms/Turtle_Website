...
const maze_einfach: Field[][] = [
  [Field.START,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,],
  [Field.EMPTY,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,],
  [Field.EMPTY,Field.WALL,Field.EMPTY,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,],
  [Field.EMPTY,Field.WALL,Field.EMPTY,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,],
  [Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,],
  [Field.EMPTY,Field.WALL,Field.EMPTY,Field.WALL,Field.WALL,Field.EMPTY,Field.EMPTY,Field.WALL,Field.WALL,Field.WALL,],
  [Field.WALL,Field.WALL,Field.EMPTY,Field.WALL,Field.WALL,Field.WALL,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.EMPTY,],
  [Field.WALL,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.WALL,Field.EMPTY,Field.WALL,Field.WALL,Field.EMPTY,],
  [Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.WALL,Field.EMPTY,],
...
const maze_mittel: Field[][] = [
  ...
  [Field.EMPTY,Field.WALL,Field.EMPTY,Field.EMPTY,Field.WALL,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.WALL,Field.EMPTY,],
  [Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.EMPTY,Field.EMPTY,],
  [Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.WALL,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.WALL,],
  [Field.WALL,Field.EMPTY,Field.WALL,Field.EMPTY,Field.EMPTY,Field.EMPTY,Field.WALL,Field.EMPTY,Field.WALL,Field.WALL,],
            ...
            <ModalDialog color="success" variant="plain">
              ...
              >
                <Typography>
                  ...
                  Kurs absolviert hast und bedanke mich nochmal herzlich bei
                  dir für deine tolle Hilfe! Ich hoffe ich konnte dir auch
                  weiterhelfen und dir einiges Wissenswertes auf deinen Weg
                  geben! Ich werde meiner Familie alles über unser Abenteuer
                  erzählen. Bis hoffentlich bald! -Pebble
                </Typography>
                <img src={"/kroete.svg"} alt="PebbleImage" height={150} />
              </div>
              <a href="/urkunde.pdf" download style={{marginTop:10}}>
